...
namespace Posadmin.BusinessEntities
{
  ...
  public partial class Parametros : MasterBusinessEntity, INotifyPropertyChanged
  {
    ...
    private String m_para_llave;
    private String m_para_valor;
    private String m_para_descripcion;
    ...
    /// <summary>
    /// Inicializar una nueva instancia de la clase Parametros con Instance Added.
    /// </summary>
    public static Parametros Nuevo()
    {
      try
      {
    ...
    /// <summary>
    /// Gets or sets el valor de: PARA_Llave.
    /// </summary>
    [Key]
    [DataMember]
    [Display(AutoGenerateField = true, Name = "Llave", Description = "Llave", ShortName = "Llave", Order = 2)]
    public String PARA_Llave
    {
      get { return m_para_llave; }
      set
      {
        if (m_para_llave != value)
        {
          m_para_llave = value;
          OnPropertyChanged("PARA_Llave");
        }
      }
    }
    ...
    /// </summary>
    [DataMember]
    [Display(AutoGenerateField = true, Name = "Valor", Description = "Valor", ShortName = "Valor", Order = 3)]
    ...
    /// <summary>
    /// Gets or sets el valor de: PARA_Descripcion.
    /// </summary>
    [DataMember]
    [Display(AutoGenerateField = true, Name = "Descripcion", Description = "Descripcion", ShortName = "Descripcion", Order = 4)]
    public String PARA_Descripcion
    {
      get { return m_para_descripcion; }
      set
      {
        if (m_para_descripcion != value)
        {
          m_para_descripcion = value;
          OnPropertyChanged("PARA_Descripcion");
        }
      }
    }
    ...
    /// </summary>
    [DataMember]
    [Display(AutoGenerateField = true, Name = "Usuario Creacion", Description = "Usuario Creacion", ShortName = "Usuario Creacion", Order = 5)]
    ...
    /// </summary>
    [DataMember]
    [Display(AutoGenerateField = true, Name = "Fecha Creacion", Description = "Fecha Creacion", ShortName = "Fecha Creacion", Order = 6)]
    ...
    /// </summary>
    [DataMember]
    [Display(AutoGenerateField = true, Name = "Usuario Modificacion", Description = "Usuario Modificacion", ShortName = "Usuario Modificacion", Order = 7)]
    ...
    /// </summary>
    [DataMember]
    [Display(AutoGenerateField = true, Name = "Fecha Modificacion", Description = "Fecha Modificacion", ShortName = "Fecha Modificacion", Order = 8)]
    [DisplayFormat(DataFormatString = "{0:yyyy-MM-ddTHH:mm:ss}", ApplyFormatInEditMode = true)]
    [DataType(DataType.DateTime)]
