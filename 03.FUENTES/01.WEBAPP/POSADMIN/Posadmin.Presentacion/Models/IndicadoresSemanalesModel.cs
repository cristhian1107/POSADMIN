...
{
  public class IndicadoresSemanalesModel
  {
    #region [ VARIABLES ]
    ...
    /// <summary>
    /// Gets or sets el valor de: Desde
    /// </summary>
    [Display(AutoGenerateField = false, Name = "Fec. Desde", Description = "Fec. Desde", ShortName = "Fec. Desde", Order = 0)]
    [DisplayFormat(DataFormatString = "{0:yyyy-MM-dd}", ApplyFormatInEditMode = true)]
    public DateTime FiltroFecDesde { get; set; }

    /// <summary>
    /// Gets or sets el valor de: Hasta
    /// </summary>
    [Display(AutoGenerateField = false, Name = "Fec. Hasta", Description = "Fec. Hasta", ShortName = "Fec. Hasta", Order = 0)]
    [DisplayFormat(DataFormatString = "{0:yyyy-MM-dd}", ApplyFormatInEditMode = true)]
    public DateTime FiltroFecHasta { get; set; }
