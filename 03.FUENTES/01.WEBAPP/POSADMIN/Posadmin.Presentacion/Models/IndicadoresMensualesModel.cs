...
{
  public class IndicadoresMensualesModel
  {
    #region [ VARIABLES ]
    ...
    /// <summary>
    /// Gets or sets el valor de: FiltroMes
    /// </summary>
    [Display(AutoGenerateField = false, Name = "Mes", Description = "Mes", ShortName = "Mes", Order = 0)]
    public Int32 FiltroMes { get; set; }
